...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User', createEmptyInstance: create)
    ...
    ..e<Gender>(5, _omitFieldNames ? '' : 'gender', $pb.PbFieldType.OE, defaultOrMaker: Gender.MAN, valueOf: Gender.valueOf, enumValues: Gender.values)
    ...
    ..aOM<Preferences>(9, _omitFieldNames ? '' : 'preferences', subBuilder: Preferences.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set birthday($core.int v) { $_setSignedInt32(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(9)
  set preferences(Preferences v) { setField(9, v); }
  @$pb.TagNumber(9)
